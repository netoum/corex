...
var Corex = (() => {
  ...
  var require_anatomy = __commonJS({
    "js/corex/@zag-js/anatomy.js"(exports, module) {
      "use strict";
  ...
  var require_dom_query = __commonJS({
    "js/corex/@zag-js/dom-query.js"(exports, module) {
      "use strict";
      var __defProp2 = Object.defineProperty;
      var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
      var __getOwnPropNames2 = Object.getOwnPropertyNames;
      ...
      function isComposingEvent(event) {
        var _a, _b;
        return (_b = (_a = event.nativeEvent) == null ? void 0 : _a.isComposing) != null ? _b : event.isComposing;
      }
      ...
      var getValueText = (item) => {
        var _a, _b;
        return sanitize((_b = (_a = item.dataset.valuetext) != null ? _a : item.textContent) != null ? _b : "");
      };
      ...
      function proxyTabFocus(container, options) {
        const _a = options, { defer, triggerElement } = _a, restOptions = __objRest(_a, ["defer", "triggerElement"]);
        const func = defer ? raf : (v) => v();
        const cleanups2 = [];
        cleanups2.push(
          func(() => {
            ...
            cleanups2.push(proxyTabFocusImpl(node, __spreadValues({ triggerElement: trigger }, restOptions)));
          })
        );
        return () => {
          cleanups2.forEach((fn) => fn == null ? void 0 : fn());
      ...
      function createScope(methods) {
        ...
        return __spreadValues(__spreadValues({}, dom), methods);
      }
  ...
  var require_aria_hidden = __commonJS({
    "js/corex/@zag-js/aria-hidden.js"(exports, module) {
      "use strict";
      var __defProp2 = Object.defineProperty;
      var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
      var __getOwnPropNames2 = Object.getOwnPropertyNames;
  ...
  var require_store = __commonJS({
    "js/corex/@zag-js/store.js"(exports, module) {
      "use strict";
      var __defProp2 = Object.defineProperty;
      var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
      var __getOwnPropNames2 = Object.getOwnPropertyNames;
  ...
  var require_core = __commonJS({
    "js/corex/@zag-js/core.js"(exports, module) {
      "use strict";
      var __defProp2 = Object.defineProperty;
      var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
      var __getOwnPropNames2 = Object.getOwnPropertyNames;
      ...
      var Machine = class {
        ...
        constructor(config, options) {
          ...
          __publicField2(this, "setupContextWatchers", () => {
            ...
            const cleanup = (0, import_store2.subscribe)(this.state.context, () => {
              ...
              for (const [key, fn] of Object.entries(watch)) {
                const isEqual = (_b2 = (_a2 = this.options.compareFns) == null ? void 0 : _a2[key]) != null ? _b2 : Object.is;
          ...
          __publicField2(this, "setOptions", (options2) => {
            ...
            this.actionMap = __spreadValues(__spreadValues({}, this.actionMap), opts.actions);
            this.delayMap = __spreadValues(__spreadValues({}, this.delayMap), opts.delays);
            this.activityMap = __spreadValues(__spreadValues({}, this.activityMap), opts.activities);
            this.guardMap = __spreadValues(__spreadValues({}, this.guardMap), opts.guards);
          });
  ...
  var require_dom_event = __commonJS({
    "js/corex/@zag-js/dom-event.js"(exports) {
      ...
      function isLinkElement(element) {
        var _a;
        return (_a = element == null ? void 0 : element.matches("a[href]")) != null ? _a : false;
      }
      ...
      function trackVisualViewport(doc, fn) {
        ...
        const onResize = () => {
          fn == null ? void 0 : fn(getViewportSize(win));
        };
        onResize();
      ...
      function trackInteractOutsideImpl(node, options) {
        ...
        function onPointerDown(event) {
          function handler() {
            var _a, _b;
            const func = defer ? domQuery.raf : (v) => v();
            const composedPath = (_b = (_a = event.composedPath) == null ? void 0 : _a.call(event)) != null ? _b : [event.target];
            func(() => {
    ...
    "js/corex/@zag-js/dismissable.js"(exports) {
      ...
      function trackDismissableElementImpl(node, options) {
        ...
        function exclude(target) {
          ...
          const persistentElements = (_a = options.persistentElements) == null ? void 0 : _a.map((fn) => fn()).filter(domQuery.isHTMLElement);
  ...
  var require_types = __commonJS({
    "js/corex/@zag-js/types.js"(exports, module) {
      "use strict";
      var __defProp2 = Object.defineProperty;
      var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
      var __getOwnPropNames2 = Object.getOwnPropertyNames;
  ...
  var require_dialog = __commonJS({
    "js/corex/@zag-js/dialog.js"(exports, module) {
      "use strict";
      var __defProp2 = Object.defineProperty;
      var __getOwnPropDesc2 = Object.getOwnPropertyDescriptor;
      var __getOwnPropNames2 = Object.getOwnPropertyNames;
      ...
      function connect2(state, send, normalize) {
        ...
        return {
          ...
          getTriggerProps() {
            return normalize.button(__spreadProps(__spreadValues({}, parts.trigger.attrs), {
          ...
          getBackdropProps() {
            return normalize.element(__spreadProps(__spreadValues({}, parts.backdrop.attrs), {
              dir: state.context.dir,
              hidden: !open,
          ...
          getPositionerProps() {
            return normalize.element(__spreadProps(__spreadValues({}, parts.positioner.attrs), {
              dir: state.context.dir,
          ...
          getContentProps() {
            return normalize.element(__spreadProps(__spreadValues({}, parts.content.attrs), {
              dir: state.context.dir,
          ...
          getTitleProps() {
            return normalize.element(__spreadProps(__spreadValues({}, parts.title.attrs), {
              dir: state.context.dir,
              id: dom.getTitleId(state.context)
            }));
          },
          getDescriptionProps() {
            return normalize.element(__spreadProps(__spreadValues({}, parts.description.attrs), {
              dir: state.context.dir,
              id: dom.getDescriptionId(state.context)
            }));
          },
          getCloseTriggerProps() {
            return normalize.button(__spreadProps(__spreadValues({}, parts.closeTrigger.attrs), {
              dir: state.context.dir,
          ...
          },
          {
            ...
            actions: {
              ...
              setFinalFocus(ctx2) {
                ...
                queueMicrotask(() => {
                  var _a, _b;
                  const el = (_b = (_a = ctx2.finalFocusEl) == null ? void 0 : _a.call(ctx2)) != null ? _b : dom.getTriggerEl(ctx2);
  ...
  var dialog_default = {
    mounted() {
      ...
      this.handleEvent("dialog", (event) => {
        const openState = (event == null ? void 0 : event.setOpen) === false;
