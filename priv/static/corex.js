var Corex = (() => {
  ...
  function getWindow(el) {
    ...
    if (isDocument(el))
      return (_a = el.defaultView) != null ? _a : window;
    if (isHTMLElement(el))
      return (_c = (_b = el.ownerDocument) == null ? void 0 : _b.defaultView) != null ? _c : window;
    return window;
  }
  ...
  function createScope(methods) {
    ...
    return __spreadValues(__spreadValues({}, dom2), methods);
  }
      ...
      __publicField(this, "createEveryActivities", (every, callbackfn) => {
        ...
        if (isArray(every)) {
          const picked = toArray(every).find((transition) => {
            ...
            return guard != null ? guard : delay22 != null;
          });
          if (!picked)
            return;
  ...
  function trapFocus(el, options = {}) {
    ...
    raf(() => {
      ...
      if (!contentEl)
        return;
      trap = createFocusTrap(contentEl, __spreadProps(__spreadValues({
        ...
        activities: {
          ...
          trapFocus(ctx2) {
            ...
            return trapFocus(contentEl, {
              ...
              setReturnFocus: (el) => {
                var _a, _b;
                return (_b = (_a = ctx2.finalFocusEl) == null ? void 0 : _a.call(ctx2)) != null ? _b : el;
              }
            });
          },
