defmodule Corex.MixProject do
  ...
  def project do
    [
      ...
      aliases: aliases(),
      source_url: @scm_url,
      homepage_url: "https://www.corexframework.org",
  ...
  def application do
    [
      ...
      env: [
        ...
        # static_compressors: [Corex.Digester.Gzip]
      ]
    ]
  end
  ...
  defp deps do
    [
      ...
      # TODO drop corex_view as an optional dependency in Corex v2.0
  ...
  #     "Adapters and Plugs": [
  #       Corex.CodeReloader,
  #       Corex.Endpoint.Cowboy2Adapter,
  #       Corex.Endpoint.SyncCodeReloadPlug
  #     ],
  #     Digester: [
  #       Corex.Digester.Compressor,
  #       Corex.Digester.Gzip
  #     ],
  #     Socket: [
  #       Corex.Socket.Broadcast,
  #       Corex.Socket.Message,
  #       Corex.Socket.Reply,
  #       Corex.Socket.Serializer,
  #       Corex.Socket.Transport
  #     ]
  #   ]
  # end
